...
abstract class OmsFeature<T : FeatureConfig>(
     ...
     *
     * Note:
     * Event listeners are registered independently of the feature enabled state.
     * OMS does not automatically suppress listener execution when a feature is disabled.
     * If a listener should only act while the feature is enabled,
     * that check must be implemented explicitly by the feature developer.
     *
